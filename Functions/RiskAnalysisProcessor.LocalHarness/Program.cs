...
var function = new RiskAnalysisProcessor.RiskAnalysisProcessor();

Console.WriteLine("Listening for order status events on risk_analysis_queue.fifo... (Ctrl+C to stop)");
